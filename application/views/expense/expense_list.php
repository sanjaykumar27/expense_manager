                ...
                <div class="m-portlet m-portlet--success m-portlet--head-solid-bg">
                    <div class="m-portlet__head" style="width: 100%;">
                        ...
                        <div style="text-align: right; vertical-align: middle;padding-top: 15px;">
                            <div class="m-portlet__head-title">
                                <a class="btn m-btn--pill btn-dark ripple" href="<?php echo base_url(); ?>expense/create_expense">Add Expense</a>
                            </div>
                        </div>
                    </div>
    ...
    $(function ()
    {
        var DatatableDataLocalDemo = {
            init: function ()
            {
                ...
                }).val(void 0 !== i.category_name ? i.category_name : ""), $("#m_form_type").on("change", function ()
                {
