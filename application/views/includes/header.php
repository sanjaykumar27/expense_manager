<html lang="en" >
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/demo/custom.css" rel="stylesheet" type="text/css" />
        <!--end::Base Styles -->
                        ...
                        <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="javascript:void(0)" class="m-brand__logo-wrapper">
                                    <img alt="" src="<?php echo base_url(); ?>assets/demo/demo5/media/img/logo/logo.png"/>
                                </a>
                            </div>
            ...
            <div class="m-container m-container--responsive m-container--xxl m-container--full-height m-page__container">
                <div class="m-stack m-stack--ver m-stack--desktop">
                    ...
                    <div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
                        ...
                        <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
                            <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                                <li class="m-menu__item <?php if($page_name == 'dashboard'){ echo 'm-menu__item--active';} ?>"  aria-haspopup="true">
                                ...
                                <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel <?php if($page_name == 'Expense' || $page_name == 'Create Expense'){ echo 'm-menu__item--active';} ?>"  m-menu-submenu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                                        ...
                                        <ul class="m-menu__subnav">
                                            <li class="m-menu__item "  aria-haspopup="true">
                                                <a  href="<?php echo base_url(); ?>expense/create_expense" class="m-menu__link ">
                                            ...
                                            <li class="m-menu__item  m-menu__item--submenu"  aria-haspopup="true">
                                                <a href="<?php echo base_url(); ?>expense/expense_list" class="m-menu__link">
                                ...
                                <li class="m-menu__item  m-menu__item--submenu m-menu__item--rel <?php if($page_name == 'category_master'){ echo 'm-menu__item--active';} ?>"  m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                                    <a  href="javascript:;" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__item-here"></span>
                                        <span class="m-menu__link-text">
                                            Admin
                                            ...
                                            <ul class="m-menu__content">
                                                <li class="m-menu__item">
                                                    ...
                                                    <ul class="m-menu__inner">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="<?php echo base_url(); ?>dashboard/categories" class="m-menu__link ">
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="<?php echo base_url(); ?>dashboard/accounts" class="m-menu__link ">
                                                                <i class="m-menu__link-icon flaticon-map"></i>
                                                                <span class="m-menu__link-text">
                                                                    Accounts
                                                                </span>
                    ...
                    <div class="m-stack__item m-stack__item--middle m-dropdown m-dropdown--arrow m-dropdown--large m-dropdown--mobile-full-width m-dropdown--align-right m-dropdown--skin-light m-header-search m-header-search--expandable m-header-search--skin-" id="m_quicksearch" m-quicksearch-mode="default">
                        <!--begin::Search Form -->
                        <form class="m-header-search__form" style="margin-bottom:0px;">
