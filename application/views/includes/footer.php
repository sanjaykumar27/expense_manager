<footer class="m-grid__item m-footer " style="background-color: #333">
<!--        <div class="m-container m-container--responsive m-container--xxl m-container--full-height m-page__container">
            <div class="m-footer__wrapper">
                <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                    <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                        <span class="m-footer__copyright">
                            2019 &copy; Expense Management Project
                            <a href="https://mindfulinternet.com" class="m-link">
                                Mindful Internet
                            </a>
                        </span>
                    </div>
...
<!-- begin::Quick Sidebar -->
        ...
        <!--<scrip<!--t src="<?php echo base_url(); ?>assets/demo/default/custom/crud/metronic-datatable/base/html-table.js" type="text/javascript"></script>
        end::Page Snippets -->
    </body>
    <!-- end::Body -->
</html>